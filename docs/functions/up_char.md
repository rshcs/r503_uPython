...
Source: `r503u.py` (method `R503.up_char`)

## Summary

** Not tested with MicroPython ** Upload the data in template buffer to the upper computer parameter: (int) timeout: timeout could vary if you change the baud rate, for 57600baud 5seconds is sufficient If you use a lower baud rate timeout may have to be increased.

## Signature

```py
up_char(timeout=5, raw=False)
```
...
- Source code: [https://github.com/rshcs/r503_uPython/blob/main/r503u.py#L337](https://github.com/rshcs/r503_uPython/blob/main/r503u.py#L337)
